                ...
                <form action="authLogin.php" method="POST">
                    <div class="container-fluid">
                        <div class="row col customBackground">
                            ...
                            <div class="container">
                                <div class="row">
                                    <button type="submit" class="btn btn-primary mb-3 ms-3 col-2">Login</button>
                                    <a href="register.php" class="btn btn-primary col-2 ms-auto mt-1 mb-3 me-2 text-light">Register</a>
                                </div>
                            </div>
                            <?
                            ...
                            <div class="container">
                                    <div class="row">
                                        <div class="text-danger">
                                            <label class="form-label col-form-label-lg">Invalid User, confirm your data!</label>
                                        </div>
                                    </div>
                                </div>
                            <?  }     ?>
                            <?
                                if (isset($_GET['login']) && $_GET['login']== 'registered') {
                            ?>
                            <div class="container">
                                    <div class="row">
                                        <div class="col text-success">
                                            <label class="form-label col-form-label-lg">Register successful!</label>
                                        </div>
                                    </div>
                                </div>
                            <?  }     ?>

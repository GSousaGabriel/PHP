                ...
                <form action="newRegister.php" method="POST">
                    <div class="container-fluid">
                        <div class="row col customBackground">
                            ...
                            <div class="container">
                                <div class="row">
                                    <button type="submit" class="btn btn-primary mb-3 ms-3 col-2">Register</button>
                                </div>
                                <?
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col text-danger">
                                                <label class="form-label col-form-label-lg">error registering your user, try again!</label>
                                            </div>
                                        </div>
                                    </div>
                                <?  }     ?>
